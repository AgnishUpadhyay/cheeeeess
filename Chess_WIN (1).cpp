...
"5)Computer will take around 8 seconds (15seconds max) to move. \n| Please Be Patient  ( ႎ _ ႎ ) |.\n"

"6)You can type 'current' (without quotes and spaces) to see what moves are available.\n"

"7)Type 'eval' to see white and black material and position score.\n"

"8)Type  'exit' if you want to exit game.\n\n"
